...
problem="GC_Qz" #GC_SVD or VC_SVD or GC_SVD_concat #Check batch size, lr!!!!!

seed="4"
latent_dim="4"
extraD_L="3" #2-12
extraD_M="3" #2-12
net="ESP_soft"  # 'ESP3' (GFINNs) or 'ESP3_soft' (SPNN) or 'ESP' or 'ESP_soft'
iterations="100010"
