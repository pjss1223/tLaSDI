...
OUTPUT_PREFIX=${problem}_${latent_dim_q}_${latent_dim_v}_${latent_dim_sigma}_${net}_${lambda_r_SAE}_${lambda_jac_SAE}_${lambda_dx}_${lambda_dz}_${lam}_${lr}_${weight_decay_GFINNs}_${weight_decay_GFINNs}_${iterations}
