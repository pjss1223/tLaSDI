...
OUTPUT_PREFIX=${problem}_${latent_dim}_${net}_exDL${extraD_L}_exDM${extraD_M}_xs${xi_scale}_${lambda_r_SAE}_${lambda_jac_SAE}_${lambda_dx}_${lambda_dz}_${lam}_gamma${gamma_lr}_lr${lr}_${activation}_sknn${layers_sk}_${width_sk}_${iterations}_batch${batch_size}_seed${seed}
