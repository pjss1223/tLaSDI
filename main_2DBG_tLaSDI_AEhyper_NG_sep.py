...
if __name__ == "__main__":
    ...
    parser.add_argument('--sys_name', default='2DBurgers', type=str, help='physic system name') 
    ...
    parser.add_argument('--trunc_period', default=trunc_period, type=int, help='trunc_period for jacobian')
