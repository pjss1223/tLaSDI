...
#(self,num_sensor, ind, extraD, depth_trunk=2, width_trunk=50, depth_hyper=2, width_hyper=50, act_trunk='relu', act_hyper='relu', initializer='default',softmax=False):
    ...
    ln.Brain_hyper_sim_grad_jac_greedy.Init(**args2)
    ln.Brain_hyper_sim_grad_jac_greedy.Run()
    ln.Brain_hyper_sim_grad_jac_greedy.Restore()
    ln.Brain_hyper_sim_grad_jac_greedy.Output()
    ln.Brain_hyper_sim_grad_jac_greedy.Test()
