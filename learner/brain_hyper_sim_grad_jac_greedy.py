...
class Brain_hyper_sim_grad_jac_greedy:
...
#        self.latent_idx = latent_idx
    ...
    def run(self):
        ...
        for i in range(self.iterations + 1):
            ...
            loss = loss_GFINNs+self.lambda_r*loss_AE+ self.lambda_dx*loss_dx +self.lambda_dz*loss_dz+self.lambda_jac*loss_AE_jac#+loss_AE_GFINNs
        ...
        return self.loss_history, self.loss_GFINNs_history, self.loss_AE_history, self.loss_dx_history, self.loss_dz_history, self.loss_AE_jac_history, data
