...
class Brain_hyper_sim_gradx_jac_greedy:
...
#        self.latent_idx = latent_idx
    ...
    def run(self):
        ...
        for i in range(self.iterations + 1):
            ...
            loss = loss_GFINNs+self.lambda_r*loss_AE+ self.lambda_dx*loss_dx +self.lambda_jac*loss_AE_jac#+loss_AE_GFINNs
            ...
            if i % self.print_every == 0 or i == self.iterations:
                ...
                # print(loss_AE)
                # print(err_max)
                print(' ADAM || It: %05d, Loss: %.4e, loss_GFINNs: %.4e, loss_AE_recon: %.4e, loss_dx: %.4e, loss_jac: %.4e, validation test: %.4e' %
                    (i, loss.item(), loss_GFINNs.item(), loss_AE.item(), loss_dx.item(),loss_AE_jac.item(), err_max))
