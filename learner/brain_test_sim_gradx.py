        ...
        for i in range(self.iterations + 1):
           ...
           # loss_AE_GFINNs = torch.mean((z_sae_gfinns_tr_norm - z_gt_tr_norm1) ** 2)
            ...
            if i % self.print_every == 0 or i == self.iterations:
                ...
                loss_test = loss_GFINNs_test+self.lambda_r*loss_AE_recon_test+self.lambda_dx*loss_dx_test#+loss_dz_test
                ...
                print(' ADAM || It: %05d, Loss: %.4e, loss_GFINNs: %.4e, loss_AE_recon: %.4e, loss_dx: %.4e, Test: %.4e' %
                      (i, loss.item(),loss_GFINNs.item(),loss_AE_recon.item(),loss_dx.item(), loss_test.item()))
