...
#        self.latent_idx = latent_idx
    ...
    def run(self):
        ...
        for para_i in self.train_indices:
            ...
            z_gt_tr = self.dataset.z[:self.dt-1, :]
            z_gt_tt = self.dataset.z[:self.dt-1, :]

            z1_gt_tr = self.dataset.z[1:self.dt, :]
            z1_gt_tt = self.dataset.z[1:self.dt, :]
