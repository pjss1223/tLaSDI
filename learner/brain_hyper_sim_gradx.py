...
#        self.latent_idx = latent_idx
    ...
    def run(self):
        ...
        for i in range(self.iterations + 1):
            ...
            loss = loss_GFINNs+self.lambda_r*loss_AE+self.lambda_dx*loss_dx
            ...
            if i % self.print_every == 0 or i == self.iterations:
                ...
                loss_test = loss_GFINNs_test+self.lambda_r*loss_AE_test+self.lambda_dx*loss_dx_test

                # print('{:<9}a loss: %.4e{:<25}Test loss: %.4e{:<25}'.format(i, loss.item(), loss_test.item()), flush=True)
                print( ' ADAM || It: %05d, Loss: %.4e, loss_GFINNs: %.4e, loss_AE_recon: %.4e, loss_dx: %.4e, Test: %.4e' %
                    (i, loss.item(), loss_GFINNs.item(), loss_AE.item(), loss_dx.item(),loss_test.item()))
