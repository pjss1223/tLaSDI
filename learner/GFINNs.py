...
class GFINNs_solver:
    ...
    def Init(cls, data, net, x_trunc,latent_idx,dt,z_gt,sys_name,output_dir,save_plots, criterion, optimizer, lr, iterations, lbfgs_steps, path=None, batch_size=None,
             ...
             device='cpu'):
        cls.GFINNs = cls(data, net,x_trunc, latent_idx,dt, z_gt,sys_name,output_dir,save_plots ,criterion, optimizer, lr, weight_decay, iterations, lbfgs_steps, path, batch_size,
    ...
    def Output(cls, data=True, best_model=True, loss_history=True, info=None, **kwargs):
        cls.GFINNs.output(data, best_model, loss_history, info, **kwargs)

    @classmethod
    def Loss_history(cls):
        return cls.GFINNs.loss_history

    @classmethod
    def Encounter_nan(cls):
        return cls.GFINNs.encounter_nan

    @classmethod
    def Best_model(cls):
        return cls.GFINNs.best_model
