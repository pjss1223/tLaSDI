    ...
    def run(self):
        ...
        for i in range(self.iterations + 1):
            ...
            if i % self.print_every == 0 or i == self.iterations:
                ...
                # print(loss_AE)
                # print(err_max)
                print(' ADAM || It: %05d, Loss: %.4e, loss_GFINNs: %.4e, loss_AE_recon: %.4e, validation test: %.4e' %
                    (i, loss.item(), loss_GFINNs.item(), loss_AE.item(), err_max))
